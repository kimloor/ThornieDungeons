...
.md-equip-stat-chip { border:1px solid rgba(255,209,102,.28); background:rgba(0,0,0,.22); border-radius:999px; padding:3px 8px; font-size:10px; font-weight:800; color:var(--ink-soft); }
...
.md-inventory-title { font-family:'Baloo 2'; font-size:16px; font-weight:800; color:var(--gold); }
.md-inventory-count { font-size:10px; color:var(--ink-soft); font-weight:800; }
