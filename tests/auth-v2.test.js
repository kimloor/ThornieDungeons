...
function createDb() {
  ...
  `);
  // Auth v11 is already deployed and intentionally is not replayed from the Battle
  // branch. Keep its additive shape as a test-only fixture so backend regression
  // tests can exercise the production-compatible schema without shipping v11 again.
