/**
 * THORNIE DUNGEONS — Cloud Save Backend (Normalized Schema)
 * ------------------------------------------------
...
const SHEETS = {
  ...
  progress: { name: "progress", headers: ["player_id", "bank_gold", "best_floor", "up_atk", "up_def", "up_hp", "up_mp", "char_level", "char_xp", "char_g_atk", "char_g_def", "char_g_hp", "char_g_mp", "updated_at"] },
...
function handleRegister(id, password) {
  ...
  appendRowByHeaders(progressSheet, SHEETS.progress.headers, {
    player_id: id, bank_gold: 0, best_floor: 1, up_atk: 0, up_def: 0, up_hp: 0, up_mp: 0,
    char_level: 1, char_xp: 0, char_g_atk: 0, char_g_def: 0, char_g_hp: 0, char_g_mp: 0, updated_at: now,
  });
